	...
	<body>
		<div id="addAll">
			...
			<script type="text/javascript">
				function fileChange222(){//注意：此处不能使用jQuery中的change事件，因此仅触发一次，因此使用标签的：onchange属性

					$.ajaxFileUpload({
						url: "/product/ajaxImg.do",//用于文件上传的服务器端请求地址
						...
						success: function(obj) //服务器成功响应处理函数
						{
							...
							$("#imgName").html("系统中生成的图片名称:"+obj.imgurl);
						},
					...
					<table>
						...
						<tr>
							...
							<td> <br><div id="imgDiv" style="display:block; width: 40px; height: 50px;"><img src="${pageContext.request.contextPath}/image_big/${product.pImage}" width="100px" height="100px" ></div><br><br><br><br>
								<input type="file" id="pimage" name="pimage" onchange="fileChange222()">
